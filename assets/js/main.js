...
const solutionsData = {
  ...
  'fire-safety': {
    ...
    how: 'Fosem approaches fire protection with zero compromise. We perform code validation and draft cause-and-effect matrix plans for complex facilities. Our certified teams install addressable alarm systems and VESDA early warning aspiration smoke detection in high-value data environments. We execute the hardware integrations with HVAC dampers, elevator recall mechanisms, and access control overrides to guarantee automatic containment during emergency triggers.',
    deliverables: [
